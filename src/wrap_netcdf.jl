...
function ncdump_parallax(fname_nc::String,ref_fname_nc::String,lon_grid::Array{Real,1},lat_grid::Array{Real,1},gph_grid::Array{Real,2},val_grid::Array{Real,2},read_vname::String)
    ...
    ds_new.attrib["satellite_name"] = ds_old.attrib["satellite_name"]
    ds_new.attrib["used_band"] = ds_old.attrib["band_number"]
    ds_new.attrib["equator_radius"] = ds_old.attrib["equator_radius"]
    ds_new.attrib["polar_radius"] = ds_old.attrib["polar_radius"]
    ds_new.attrib["satellite_longitude"] = ds_old.attrib["satellite_longitude"]
    ds_new.attrib["satellite_latitude"] = ds_old.attrib["satellite_latitude"]
    ds_new.attrib["satellite_earth_center_distance"] = ds_old.attrib["satellite_earth_center_distance"]
    ds_new.attrib["nadir_longitude"] = ds_old.attrib["nadir_longitude"]
    ds_new.attrib["nadir_latitude"] = ds_old.attrib["nadir_latitude"]
    ds_new.attrib["wavelength"] = ds_old.attrib["wavelength"]
    _fillvalue = ds_old.attrib["_FillValue"]
    ...
    tim = defVar(ds_new,"obs_time",Float64,("obs_time",), attrib = OrderedDict(
            "units" => ds_old["obs_time"].attrib["units"], 
            "long_name" => ds_old["obs_time"].attrib["long_name"]
            ))
    ...
    val = defVar(ds_new,read_vname,Float32,("longitude","latitude"), attrib = OrderedDict(
            ...
            "long_name" => ds_old[read_lname].attrib["long_name"],
            "_FillValue" => _fillvalue,
            ))
